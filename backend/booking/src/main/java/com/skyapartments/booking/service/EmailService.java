...
public class EmailService {
    ...
    public void sendCheckInReminder(String toEmail, BookingDTO booking, ApartmentDTO apartment, UserDTO user) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setFrom(fromEmail);
            helper.setTo(toEmail);
            helper.setSubject("Check-in Reminder - Sky Apartments #" + booking.getId());
            helper.setText(buildCheckInReminderContent(booking, apartment, user), true);
    ...
    private String buildCheckInReminderContent(BookingDTO booking, ApartmentDTO apartment, UserDTO user) {
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <div class="greeting">
                            <p>Dear %s,</p>
                            <p>We're excited to welcome you to Sky Apartments! Your check-in date is just around the corner.</p>
                        </div>
                        
                        <div class="countdown-box">
                            <div>⏰ Check-in in</div>
                            <div class="countdown-text">7 Days!</div>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <ul class="info-list">
                                ...
                                <li>Keys will be provided at reception</li>
                                <li>Contact us if you need early check-in or late check-out</li>
                            </ul>
                        </div>
                        
                        <div class="highlight">
                            📍 Need directions or have questions?<br>
                            Contact us anytime!
                        </div>
