...
\else
  ...
  \IfFontExistsTF{Consolas}{
    ...
    \newfontfamily\ConsolasFont{Latin Modern Mono}
  }
  \newcommand{\codefont}{\ConsolasFont}
\fi

\newcommand{\jsonbasicfont}{\codefont\footnotesize}
\newcommand{\codeboldfont}{\bfseries\codefont}
...
\mtcsettitle{minitoc}{Contenido del capítulo}
...
\usepackage{booktabs}  % Para las líneas profesionales de la tabla
\usepackage{graphicx} % Para ajustar el tamaño de la gráfica
...
keywordstyle=\codeboldfont\color{myteal},
%keywordstyle=\ttb\color{myteal},
commentstyle=\itshape\color{myteal},
stringstyle=\color{mydeepteal},
emph={MyClass,__init__},          % Custom highlighting
emphstyle=\codeboldfont\color{mydeepteal},    % Custom highlighting style
